  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<EventsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<EventsRow> resultPageEventsRowList = snapshot.data!;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      height: MediaQuery.sizeOf(context).height * 0.612,
                      decoration: const BoxDecoration(),
                      child: Builder(
                        builder: (context) {
                          final events = resultPageEventsRowList.toList();
                            ...
                            children:
                              ...
                              return Container(
                                ...
                                child: EventListWidget(
                                  key: Key(
                                      'Key94x_${eventsIndex}_of_${events.length}'),
                                  eventId: eventsIndex.toString(),
                                ),
                              );
                            }),
                          );
