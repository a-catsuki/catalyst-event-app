                          ...
                          Padding(
                            ...
                            child: Text(
                              valueOrDefault<String>(
                                eventInformationEventsRow?.name,
                                'Event Name',
                              ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  dateTimeFormat(
                                    "MMMEd",
                                    eventInformationEventsRow!.startDateTime,
                                ...
                                Text(
                                  valueOrDefault<String>(
                                    '${dateTimeFormat(
                                      ...
                                      "jm",
                                      eventInformationEventsRow.endDateTime,
                                      locale: FFLocalizations.of(context)
                                          .languageCode,
                                    )}',
                                    '12:00am - 12:00pm',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  valueOrDefault<String>(
                                    '${eventInformationEventsRow.startDateTime.toString()} - ${eventInformationEventsRow.endDateTime.toString()}',
                                    '12:00am - 12:00pm',
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                          ...
                          child: ListView(
                            ...
                            children: [
                              Container(
                                decoration: const BoxDecoration(),
                                child: wrapWithModel(
                                  model: _model.chatThreadUpdateModel,
                                  updateCallback: () => setState(() {}),
                                  updateOnChange: true,
                                  child: const ChatThreadUpdateWidget(),
                                ),
                              ),
                            ],
                          ),
